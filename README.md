...
2. Click on the Project as shown below:
    ...
    <img width="1446" alt="Step2" src="https://github.com/Zdong104/ZTrade/assets/77849792/6f75b822-79cc-4e48-994a-5b2d70d972c1">
3. Click `Product` -> `Scheme` -> `Edit Scheme`:
   
    <img width="454" alt="Step3" src="https://github.com/Zdong104/ZTrade/assets/77849792/961e60ee-2843-43b1-9309-0de773611679">
4. Under `Run`, select `Release` instead of `Debug`:
   
    <img width="1156" alt="Step4" src="https://github.com/Zdong104/ZTrade/assets/77849792/ae740bae-449c-49de-9279-b860fb2a5607">
5. Solve problem for calling external url link or domain address: Under <AppName>, select `Info`, select `App Transport Security Settings`, make `Allow Arbitrary Loads` as Yes, Add `Exception Domains` as shown below.

   <img width="1398" alt="App Transport Security" src="https://github.com/Zdong104/ZTrade/assets/77849792/ee9cea6a-2316-4426-89aa-c31010ec1209">
